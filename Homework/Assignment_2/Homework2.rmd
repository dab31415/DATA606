...
scores_df <- as_tibble(scores)
names(scores_df)[1] <- 'scores'
ggplot(scores_df,aes(x = '',y = scores)) + geom_boxplot() + labs(x = '')
...
ii. The paragraph below describes the set up for such approach, if we were to do it without using statistical software. Fill in the blanks with a number 
