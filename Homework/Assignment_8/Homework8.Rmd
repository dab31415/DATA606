...
This indicates that `r 100 * r^2`% of variations in height can be explained by variations in shoulder girth.
...
The model would predict a height of $`r height_estimate`$ cm.
...
The residual of `r residual` indicates that the model overestimated the students height.
...
\[
  \hat{heart_wt} = -0.357 + 4.034 \times body\_weight
\]
